...
export class LoginPage extends Component {
	...
	<div className="page-container container" id="content">
		<form id="login_form" className="account-form" role="form" onSubmit={this.onLoginWithPassword}>
			...
			<button id="login-with-github" type="button" className="btn btn-default btn-block" data-loading-text="Please wait..." onClick={this.onLoginWithGithub}>
			...
			<button id="login-with-twitter" type="button" className="btn btn-default btn-block" data-loading-text="Please wait..." onClick={this.onLoginWithTwitter}>
