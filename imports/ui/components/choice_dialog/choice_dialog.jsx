                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                                    ...
                                    {this.props.choiceType === "radio" ? (
                                        this.props.items.map(item => (
                                            <div className="radio" key={item._id}>
                                                <label>
                                                    <input type="radio" name="input-select" value={item._id}
                                                           defaultChecked={item._id === self.props.defaultValue}/>
                                                    {item.title}
                                                </label>
                                            </div>
                                        ))
                                    ) : (
                                        <select name="input-select" className="form-control input-control"
                                                autoFocus="autofocus"
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-default cancel-button" data-dismiss="modal"
